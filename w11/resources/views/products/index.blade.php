...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('products.trash') }}" class="btn btn-outline-danger position-relative">
                🗑 Trash
            ...
            {{-- Add button visible only if products exist --}}
            @if($products->count() > 0)
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm border-0">
                ...
                <div class="product-image-container mx-auto mt-3">
...
{{-- CSS for image thumbnails & hover effect --}}
<style>
