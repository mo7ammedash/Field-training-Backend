            ...
            <div class="bg-white border rounded-3 shadow-sm p-4">
                ...
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- suppliers errors (NO duplication) --}}
                                ...
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <input type="number" step="0.01"
                                            ...
                                            class="form-control supplier-input
                                               @error(" suppliers.$supplier->id.cost_price") is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <input type="number"
                                            ...
                                            class="form-control supplier-input
                                               @error(" suppliers.$supplier->id.lead_time_days") is-invalid @enderror"
